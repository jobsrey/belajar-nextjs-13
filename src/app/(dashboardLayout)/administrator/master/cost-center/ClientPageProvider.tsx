...
import { useQueryDataCostCenter } from "@/query/MasterCostCenterQuery";
...
const ClientPageProvider = ({ session }: IProps) => {
  const { data: collaction, isLoading } = useQueryDataCostCenter({
    ...
    <>
      <TreeContext.Provider value={tree}>
        <div className="flex justify-center items-center p-8">  
          <span className="text-lg font-bold">Master Cost Center</span>
        </div>
