...
import { useQueryDataLocation } from "@/query/MasterLocationQuery";
...
const ClientPageProvider = ({ session }: IProps) => {
  const { data: collaction, isLoading } = useQueryDataLocation({
    ...
    <>
      <TreeContext.Provider value={tree}>
        <div className="flex justify-center items-center p-8">  
          <span className="text-lg font-bold">Master Lokasi</span>
        </div>
