...
const FormCreate = ({ onSubmit, onCancel }: IPropsForm) => {
  ...
  //react query
  const { handleCreate } = useMutationDataAsset({
  ...
  return (
    <Spin spinning={isLoading}>
      ...
      >
        ...
        <FormItem control={control} label="Panjang Garansi" name="genSysId">
          <InputNumber className="w-full"/>
        </FormItem>

        <FormItem control={control} label="Panjang Garansi" name="genCosId">
          <InputNumber className="w-full"/>
        </FormItem>
